...
it('allows the application sidebar to collapse on desktop and mobile', function () {
    ...
    expect($sidebarLayout)
        ...
        ->toContain('<flux:sidebar.nav class="in-data-flux-sidebar-collapsed-desktop:hidden">')
        ...
        ->toContain('<flux:sidebar.item icon="home" :href="route(\'dashboard\')" :current="request()->routeIs(\'dashboard\')" wire:navigate>')
